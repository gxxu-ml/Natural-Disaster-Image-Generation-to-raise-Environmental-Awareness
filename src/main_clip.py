# https://github.com/mlfoundations/open_clip/blob/main/src/training/main.py
import os
import time
import logging
...
from open_clip.clip.clip import _transform, load
from open_clip.clip.model import convert_weights, CLIP
from open_clip.training.train import train, evaluate
from open_clip.training.params import parse_args
from open_clip.training.logger import setup_primary_logging, setup_worker_logging
...
def main_worker(gpu, ngpus_per_node, log_queue, args):
    ...
    if args.openai_pretrained:
        ...
        model_config_file = Path(__file__).parent / \
                f"open_clip/training/model_configs/{args.model.replace('/', '-')}.json"
    ...
    data = get_data(args, (preprocess_train, preprocess_val), 'clip')
